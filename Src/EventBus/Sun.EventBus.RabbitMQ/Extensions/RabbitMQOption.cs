...
namespace Sun.EventBus.RabbitMQ.Extensions
{
    public class RabbitMQOption
    {
        ...
        /// </summary>
        public const string DefaultExchangeName = "sun.default.router";
        ...
        /// <summary>
        /// Gets or sets queue message automatic deletion time (in milliseconds). Default 864000000
        /// ms (10 days).
        /// </summary>
        ...
        /// </summary>
        public Action<ConnectionFactory> ConnectionFactoryOption { get; set; }
    }
}